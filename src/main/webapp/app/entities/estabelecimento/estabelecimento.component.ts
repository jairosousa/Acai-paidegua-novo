...
export class EstabelecimentoComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.estabelecimentoService
            ...
            .subscribe(
                (res: HttpResponse<IEstabelecimento[]>) => this.paginateEstabelecimentos(res.body, res.headers),
    ...
    protected paginateEstabelecimentos(data: IEstabelecimento[], headers: HttpHeaders) {
