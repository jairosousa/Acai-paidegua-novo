...
import { TabelaPrecoComponent } from 'app/entities/tabela-preco/tabela-preco.component';
...
describe('Component Tests', () => {
    describe('TabelaPreco Management Component', () => {
        let comp: TabelaPrecoComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TabelaPrecoComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.tabelaPrecos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
